Shader "Custom/Parallax"
{
    Properties{
        ...
        _ParallaxStrength("Parallax Strength", Range(0, 10)) = 0.1
        _HeightMapStrength("Height Map Strength", Range(0, 10)) = 0.1
        _NormalMapStrength("Normal Map Strength", Range(0, 10)) = 0.1
    }
